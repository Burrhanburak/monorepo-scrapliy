      ...
      >
        <div
          className={cn(
            ...
            isScrolled &&
              "bg-background/50 max-w-4xl rounded-2xl  border-gray-200 backdrop-blur-lg lg:px-5"
          )}
        >
