...
interface Plan {
  ...
  features: string[];
  variant: keyof typeof pricingColumnVariants;
}
...
export default function Pricing({
  ...
  const plans: Plan[] = [
    {
      name: "Starter",
      description: "Perfect for individuals and small projects that need basic web scraping capabilities.",
      price: "$0",
      cta: {
        variant: "default",
    ...
    },
    {
      ...
      description: "Ideal for growing businesses that need advanced scraping features.",
      price: {
        monthly: "$49",
        annually: "$39"
      },
    ...
    },
    {
      ...
      description: "For large organizations requiring comprehensive web scraping solutions.",
      price: {
        monthly: "$99",
        annually: "$79"
      },
  ...
  return (
    <Section className={cn(className)}>
      <div className="flex flex-col items-center w-full max-w-[1440px] mx-auto relative overflow-visible px-6 py-12 md:px-[70px] md:py-[70px] 2xl:px-[250px] 2xl:py-[70px]">
        ...
        <span className="flex items-center mr-2 rounded-md border border-emerald-400 bg-emerald-200 px-1.5 py-0.5 text-xs leading-none text-emerald-700 no-underline dark:bg-emerald-300/10 dark:text-emerald-500 shadow-[0_0_5px_theme(colors.emerald.400),0_0_10px_theme(colors.emerald.400)] dark:shadow-[0_0_5px_theme(colors.emerald.500),0_0_10px_theme(colors.emerald.500)]">
          ...
          <div className="mb-6">
            <p className="text-base text-left leading-[1.29] text-left text-[rgba(72,73,84,0.7)] dark:text-[rgba(255,255,255,0.7)]">
              Everything you need to get started with web scraping—simplified
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          {plans.map((plan, index) => (
            <div
              key={index}
              className={cn(
                "max-w-container relative border border-gray-200 dark:border-gray-900 flex flex-col gap-6 rounded-2xl p-8 shadow-xl",
                pricingColumnVariants[plan.variant]
              )}
            >
              <hr
                className={cn(
                  "absolute top-0 left-[10%] h-[1px] w-[80%] border-0 bg-linear-to-r from-transparent to-transparent",
                  plan.variant === "glow-brand" ? "via-brand" : "via-foreground/60"
                )}
              />
              <div className="relative flex flex-col gap-7">
                ...
                <Button variant={plan.cta.variant} size="lg" asChild className="w-full">
