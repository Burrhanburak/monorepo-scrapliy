...
const switchVariants = tv({
  slots: {
    root: [
      ...
      // checked
      "data-[state=checked]:bg-blue-600 data-[state=checked]:dark:bg-[#0900FF]",
      // disabled
      "data-[disabled]:cursor-default",
      // disabled checked
      "data-[disabled]:data-[state=checked]:bg-[#0900FF]",
      "data-[disabled]:data-[state=checked]:ring-gray-300",
      // disabled checked dark
      "data-[disabled]:data-[state=checked]:dark:ring-gray-900",
      "data-[disabled]:data-[state=checked]:dark:bg-[#0900FF]",
      // disabled unchecked
